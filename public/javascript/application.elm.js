...
var _atlasr_org$atlasr$MapboxGL_Ports$mapboxgl_create_map = _elm_lang$core$Native_Platform.outgoingPort(
	'mapboxgl_create_map',
	function (v) {
		return v;
	});
...
var _atlasr_org$atlasr$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _atlasr_org$atlasr$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Search') {
			return {
			...
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _atlasr_org$atlasr$MapboxGL_Ports$mapboxgl_create_map(_p0._0)
			};
		}
	});
var _atlasr_org$atlasr$Main$Model = function (a) {
	return {search: a};
};
var _atlasr_org$atlasr$Main$init = {
	ctor: '_Tuple2',
	_0: _atlasr_org$atlasr$Main$Model(''),
	_1: _atlasr_org$atlasr$MapboxGL_Ports$mapboxgl_create_map('map')
};
var _atlasr_org$atlasr$Main$CreateMap = function (a) {
	return {ctor: 'CreateMap', _0: a};
};
var _atlasr_org$atlasr$Main$Search = function (a) {
	return {ctor: 'Search', _0: a};
};
var _atlasr_org$atlasr$Main$view = function (model) {
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_atlasr_org$atlasr$Main$Search),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
...
var _atlasr_org$atlasr$Main$main = _elm_lang$html$Html$program(
	{init: _atlasr_org$atlasr$Main$init, view: _atlasr_org$atlasr$Main$view, update: _atlasr_org$atlasr$Main$update, subscriptions: _atlasr_org$atlasr$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _atlasr_org$atlasr$Main$main !== 'undefined') {
    _atlasr_org$atlasr$Main$main(Elm['Main'], 'Main', undefined);
}
